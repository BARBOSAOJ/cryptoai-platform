          ...
          <div key={i} style={newsItemStyle}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{
                ...
                background: news.label === 'BULLISH' ? '#08998120' : news.label === 'BEARISH' ? '#f2364520' : '#243858',
                color: news.label === 'BULLISH' ? '#089981' : news.label === 'BEARISH' ? '#f23645' : '#7888b8'
              }}>
                {news.label}
              </div>
              <div style={{ fontSize: '10px', fontWeight: 'bold', color: '#384e70' }}>
                IMPACTO: {news.impact > 0 ? '+' : ''}{news.impact}
              </div>
            </div>
          </div>
        )) : (
          <div style={{ padding: '20px', textAlign: 'center', color: '#384e70', fontSize: '12px' }}>
...
const panelStyle = { width: '300px', background: '#0c1528', borderLeft: '1px solid #1a1a1a', display: 'flex', flexDirection: 'column' as const }
...
const newsItemStyle = { background: '#162440', padding: '12px', borderRadius: '8px', marginBottom: '10px', border: '1px solid #2b3139' }